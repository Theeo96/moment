...
if __name__ == "__main__":
    # 테스트 실행
    # result = get_analysis_result(1, "test_analysis.txt", "나무_7_남_00367.jpg")

    # temp_text = "./yolo_outputs/run_f50dec2f/labels/a64115a2ced047438743661a6e4f7e86.txt"
    # temp_img =  "./yolo_outputs/run_f50dec2f/a64115a2ced047438743661a6e4f7e86.jpg"

    temp_text = "./yolo_outputs/run_bfae5214/labels/1614f28b84274086a1b16471dde5f85e.txt"
    temp_img =  "./yolo_outputs/run_bfae5214/1614f28b84274086a1b16471dde5f85e.jpg"

    result = get_analysis_result(1, temp_text, temp_img)
